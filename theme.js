(function () {
    ...
    window.T = {
        ...
        // Shared site accent, matched to the Week 8 transfer-function pages.
        get accent() { return this.isDark ? '#2898BD' : '#0e7490'; },
        get accent2() { return this.isDark ? '#42B2D7' : '#0D6C88'; },
        get onAccent() { return this.isDark ? '#0a0a10' : '#ffffff'; },
        accentA: function (a) { return this.isDark ? 'rgba(40,152,189,' + a + ')' : 'rgba(14,116,144,' + a + ')'; },
        // Legacy aliases retained for existing pages.
        get yellow() { return this.isDark ? '#9DD9EE' : '#0a495c'; },
        get yellow2() { return this.isDark ? '#6CC3E0' : '#0D6C88'; },
        get yellow3() { return this.isDark ? '#42B2D7' : '#115A75'; },
        get yellowF() { return this.isDark ? '#2898BD' : '#093847'; },
        yellowA: function (a) { return this.isDark ? 'rgba(255,204,68,' + a + ')' : 'rgba(184,134,11,' + a + ')'; },
        // Three.js yellow (hex int)
        get yellow3js() { return this.isDark ? 0x9DD9EE : 0x9DD9EE; },
        get yellow3js2() { return this.isDark ? 0x6CC3E0 : 0x6CC3E0; },
        get yellow3js3() { return this.isDark ? 0x42B2D7 : 0x42B2D7; },
