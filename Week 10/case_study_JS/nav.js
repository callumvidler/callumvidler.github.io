...
(function () {
    ...
    function updateHint() {
        if (elHint) elHint.classList.toggle('hidden', current !== 0);
    }
    ...
    function go(i) {
        ...
        // Reset stale prev classes on slides ahead of the new position so the
        // forward transition direction is consistent next time.
