// Wires the multiplication scene: state, drag handles via the Argand factory,
// readout table, and the toolbar buttons (animate, unit-lock for z2, reset).
(function () {
    ...
    const btnAnim = document.getElementById('mul-animate');
    const btnUnit = document.getElementById('mul-unit');
    const btnReset = document.getElementById('mul-reset');
    const tbody = document.getElementById('mul-readout');
